...
const person1 = new Person("Ishika", "Devare", 20);
const person2 = new Person("Garvit", "Devare", 18);

console.log(person1.domain("Engineer"));
console.log(person2.domain("Pilot"));
...
try {
  const stud1 = new Student("Alice", "Bob", 12, "sa"); // generates error when NaN is passed

} catch (error) {
  console.warn("error >>> ", error);
}
const stud2 = new Student("Devashree", "Devare", 18, 17); // generates error when NaN is passed
